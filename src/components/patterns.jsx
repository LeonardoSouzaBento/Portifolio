...
const css = { wrapper: `max-w-lg m-0 max-w-max`, nameWrapper: `flex gap-2.5 mb-1 max-w-max`, icon: `mt-1.5`, };

const title = sectionsTitles.find((title) => title.keyWord === 'padrões');
...
const Patterns = () => {
  return (
    <Card id={title.keyWord} className={sectionStyles}>
      ...
      <CardContent className={`${cardStyles} pt-3 mt-3 gap-0 flex flex-col md:flex-row md:gap-12`}>
