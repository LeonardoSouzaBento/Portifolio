...
const css = {
  ...
  wrapper: `h-144 bp-min:min-w-70 bp-3:min-w-74 bp-4:min-w-80 sm:min-w-84 shadow-sm border border-border/30 hover:border-border/50 transition-all 
...
export const Projects = ({ resizeCount }: ProjectsProps) => {
              ...
              <div key={project.id} className={css.wrapper}>
                ...
                <div className={"overflow-hidden"}>
                  ...
                  <div className={`h-max px-4 overflow-y-hidden`}>
                    ...
                    {(project.id as string) !== "portfolio" && <Links project={project} />}
                  </div>
                </div>
              </div>
            );
